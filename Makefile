...
OFILES = main.o myLib.o background.o gameover.o font.o trashbin.o bananaskin.o heart.o paper.o money.o victory.o text.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = background.h gameover.h myLib.h trashbin.h bananaskin.h heart.h paper.h money.h victory.h text.h
